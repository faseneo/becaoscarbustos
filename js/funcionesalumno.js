            ...
            gettotal(pag);
                    ...
                    .done(function( data, textStatus, jqXHR ) {
                        ...
                        for(var i=0; i<data.datos.length;i++){
                                ...
                                if(data.datos[i].alumbeca_archivo_url==null){
                                    fila += '<td>No existe archivo | ';
                                }else{
                                    fila += '<td><a href="http://'+ document.domain +'/' + data.datos[i].alumbeca_archivo_url +'">Cedula</a> | ';
                                }
                                if(data.datos[i].alumbeca_archivo_url2==null){
                                    fila += 'No existe archivo </td></tr>';
                                }else{
                                    fila += '<a href="http://'+ document.domain +'/'+data.datos[i].alumbeca_archivo_url2 +'">Registro Social</a></td></tr>';
                                }    
    ...
    var buscaRut = function (rut){
                    ...
                    .done(function( data, textStatus, jqXHR ) {
                        ...
                        if (data.datos != null){
                                ...
                                if(data.datos.alumbeca_archivo_url==null){
                                    fila += '<td>No existe archivo | ';
                                }else{
                                    fila += '<td><a href="http://'+ document.domain +'/' + data.datos.alumbeca_archivo_url +'">Cedula</a> | ';
                                }
                                if(data.datos.alumbeca_archivo_url2==null){
                                    fila += 'No existe archivo </td></tr>';
                                }else{
                                    fila += '<a href="http://'+ document.domain +'/'+data.datos.alumbeca_archivo_url2 +'">Registro Social</a></td></tr>';
                                }    
